...
function fbox_engine() {
    ...
    */
	...
	var fbox_HoverNavig,fbox_prev_hover,fbox_next_hover
    var fbox_fg_inner;
    ...
    function  adjustFg(forceCaption) {
        ...
        if (showNavig) {
            if (currFbox.prev) {
				...
				fbox_prev_hover.style.visibility= 'visible';
            } else {
                fbox_prev_a.style.visibility= 'hidden';
				fbox_prev_hover.style.visibility= 'hidden';
            }
            
            if (currFbox.next) {
                fbox_next_a.style.visibility= 'visible';
				fbox_next_hover.style.visibility= 'visible';
            } else {
                fbox_next_hover.style.visibility= 'hidden';
				fbox_next_a.style.visibility= 'hidden';
            }
            
            fbox_navig.style.visibility = 'visible'; //bug or not I do it
            fbox_navig.style.display='';
			fbox_HoverNavig.style.visibility = 'visible'; //bug or not I do it
            fbox_HoverNavig.style.display='';
        } else {
            fbox_navig.style.visibility = 'hidden'; //bug or not I do it
            fbox_navig.style.display='none';
			fbox_HoverNavig.style.visibility = 'hidden'; //bug or not I do it
            fbox_HoverNavig.style.display='none';
        }
...
//------------------------------------------------------------------------------
    function showFbox(fbObj) {
		...
		fbox_prev_hover.onclick = currFbox.prev ? showPrev: nope;
        fbox_next_hover.onclick = currFbox.next ? showNext: nope;
...
//------------------------------------------------
    function init_fbox() {
		...
		fbox_HoverNavig=getElem("hoverNav"); fbox_prev_hover=getElem("prevLink"); fbox_next_hover=getElem("nextLink")
