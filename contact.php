            ...
            <div id="content_right">
					...
					<div id="about_form">
						...
						<div class="form_row">
							...
							<div class="form_right"><input type="hidden" name="form_submit" id="form_submit" value="True" /><input type='submit' value='Pošlji' class="button">&nbsp;&nbsp; <input type='button' value='Počisti ' onclick="location.href='/contact.php';" class="button"></div>
						</div>
						</form>
										</div>
